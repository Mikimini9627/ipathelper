...
from .ipathelper import (
    ...
    HOUSHIKI_WHEEL_1ST, HOUSHIKI_WHEEL_2ND, HOUSHIKI_WHEEL_3RD,
    HOUSHIKI_WHEEL_1ST_2ND, HOUSHIKI_WHEEL_1ST_3RD, HOUSHIKI_WHEEL_2ND_3RD,
    HOUSHIKI_WHEEL_MULTI_AXIS1, HOUSHIKI_WHEEL_MULTI_AXIS2,
    # 定数: 式別
    ...
    RACE_STATUS_ON_SALE, RACE_STATUS_CLOSED, RACE_STATUS_CANCELED,
...
def _init():
    ...
    _core.lib.GetNotice.restype = c_uint
    _core.lib.GetNotice.argtypes = [c_void_p]
